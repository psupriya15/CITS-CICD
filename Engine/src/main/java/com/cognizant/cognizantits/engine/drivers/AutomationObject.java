...
public class AutomationObject {
    ...
    public List<WebElement> NLP_located_element(String text) {	
    	
    	if(driver.findElements(By.xpath("//*[@placeholder='"+text+"']")).size()!=0)
    		return driver.findElements(By.xpath("//*[@placeholder='"+text+"']"));
    	else if(driver.findElements(By.xpath("//*[contains(text(),'"+text+"')]/following::input[1]")).size()!=0)
    		return driver.findElements(By.xpath("//*[contains(text(),'"+text+"')]/following::input[1]"));
    	else if(driver.findElements(By.xpath("//*[contains(text(),'"+text+"')]/following::textarea[1]")).size()!=0)
    		return driver.findElements(By.xpath("//*[contains(text(),'"+text+"')]/following::textarea[1]"));
    	else if(driver.findElements(By.xpath("//*[contains(text(),'"+text+"')]/following::select[1]")).size()!=0)
    		return driver.findElements(By.xpath("//*[contains(text(),'"+text+"')]/following::select[1]"));
    	else return null;
